...
reportsRouter.get(
  ...
  autenticar,
  exigirArea('gerencia'),
  manejar((req) => reports.afiliados(req.query.from as string, req.query.to as string, req.query.funcionario as string, req.query.sede as string)),
);
...
reportsRouter.get(
  ...
  autenticar,
  exigirArea('gerencia'),
  manejar((req) => reports.carteraSeguimiento(req.query.mes as string, req.query.sede as string, req.query.categoria as string)),
);
