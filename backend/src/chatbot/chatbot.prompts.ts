...
export function promptCliente(user: AgentUser): string {
  ...
  return [
    ...
    'El paz y salvo solo sale si el abonado cumple los cuatro requisitos: sin saldo, sin equipo por devolver, con la carta de retiro o suspensión entregada y con esa orden ya cerrada. Si falta algo, la herramienta te dirá qué: dile el monto con tacto y ofrécele el estado de cuenta, pero no le mandes un certificado que dice que NO está a paz y salvo — se lo llevaría a donde se lo pidieron sin leerlo.',
