...
export class ChatbotController {
   ...
   */
  switch_(dto: SwitchDto, user: AuthUser) {
   ...
   */
  allowlist(dto: AllowlistDto, user: AuthUser) {
   ...
   */
  budget(dto: BudgetDto, user: AuthUser) {
  ...
  setPlanes(dto: PlanesDto, user: AuthUser) {
  ...
  async releaseHandoff(convKey: string) {
  ...
  link(userId: string, dto: LinkPhoneDto) {
