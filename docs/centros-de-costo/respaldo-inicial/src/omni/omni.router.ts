...
omniRouter.get(
  '/events/mine',
  autenticar,
  manejar((req) => omni.myEvents(req.query.from as string, req.query.to as string, usuarioDe(req))),
);
...
omniRouter.delete(
  ...
  autenticar,
  exigirArea('contabilidad', 'administracion', 'caja'),
  manejar((req) => omni.deleteEvent(req.params.id, usuarioDe(req))),
);
...
omniRouter.patch(
  ...
  autenticar,
  exigirArea('contabilidad', 'administracion', 'caja'),
  manejar((req) => omni.updateEvent(req.params.id, validar(UpdateEventDto, req.body), usuarioDe(req))),
);
