...
staffRouter.get(
  ...
  autenticar,
  exigirArea('administracion', 'gerencia'),
  manejar((req) => staff.afiliados(req.query.from as string, req.query.to as string)),
);
...
staffRouter.get(
  ...
  autenticar,
  exigirArea('administracion', 'gerencia'),
  manejar((req) => staff.afiliadosDe(req.params.id, req.query.from as string, req.query.to as string)),
);
